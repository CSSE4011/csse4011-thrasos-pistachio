...
#define WIFI_AP_SSID       "ESP32-AP"        // Your ESP32's hotspot name
#define WIFI_AP_PSK        "12345678"        // Your ESP32's hotspot password
#define WIFI_AP_IP_ADDRESS "192.168.4.1"
#define WIFI_AP_NETMASK    "255.255.255.0"

/* STA Mode Configuration */
#define WIFI_SSID "csse4011"     /* Replace `SSID` with WiFi ssid. */
#define WIFI_PSK  "csse4011wifi" /* Replace `PASSWORD` with Router password. */
